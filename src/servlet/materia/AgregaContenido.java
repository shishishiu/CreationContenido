...
//	 * @throws Exception
//	 */
//	private String GetHandler(HttpServletRequest request, int parentId, int unidad, int apartado) throws Exception{
//		String handler = null;
//		String cveMat = request.getParameter(KEY_FORM_CVE_MAT);
//		String caption = request.getParameter(KEY_FORM_CAPTION);
//		TrcnMat bean = TrcnMat.Buscar(parentId);
//		String parentName = bean.getParentContName() + Common.HYPHEN + bean.getCaption();
//
//		try {
...
//	 * @throws Exception
//	 */
//	private String GetSequencia(String cveMat, int unidad, int apartado) throws Exception {
//		int sequencia = 0;
//		
